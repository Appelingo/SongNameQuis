...
**最大の効果: Apple Music 契約者がいなくても遊べる**

現状はライブラリ取込が必須で、誰か 1 人は Apple Music 契約者である必要があった。
プリセットは **developer token だけで完結する**（ライブラリ読み取りと違いユーザー認証が不要）ため、
**MusicKit の認証すら要らずにゲームが成立する**。公開サービスとしてはこれが一番大きい。
